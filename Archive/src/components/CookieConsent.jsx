    ...
    return (
        <>
            ...
            <div className="fixed bottom-[30px] left-1/2 -translate-x-1/2 w-[90%] max-w-[800px] z-[9999] pointer-events-none cookie-animate">
                <div className="pointer-events-auto bg-white/85 backdrop-blur-[15px] border border-white/30 rounded-[20px] shadow-[0_15px_35px_rgba(0,0,0,0.1)] flex flex-col md:flex-row items-start md:items-center justify-between p-6 md:p-[25px_40px_25px_25px] gap-5 md:gap-[30px] relative" data-aos="fade-up">
