                ...
                >
                  {loadError ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-full bg-slate-50 border rounded">
                      <div
                        className="animate-spin h-8 w-8 rounded-full border-4 border-[#8059ca] border-t-transparent mb-3"
                        role="status"
                      >
                        <span className="sr-only">Loading...</span>
                      </div>
                      ...
                      {activeTab === "address-details" && (
                        <div className="flex flex-col">
                            ...
                            <div className="flex gap-2 items-center mb-2">
                                ...
                                {isLoaded ? (
                                  ...
                                  >
                                    <input
                                      ...
                                      className="w-full p-[9px_12px_9px_36px] border border-solid border-slate-200 rounded-xl text-xs bg-white focus:border-[#8059ca] focus:ring-2 focus:ring-purple-100 transition-all outline-none"
                              ...
                              <button
                                ...
                                className={`px-3.5 rounded-xl text-xs font-semibold border-0 cursor-pointer transition-colors ${locationChange
                                  ...
                                  : "bg-[#f3ecff] text-[#8059ca] hover:bg-[#e7daff]"
                                  }`}
                          ...
                          <div className="mt-4">
                            <button
                              type="button"
                              className="w-full py-2.5 bg-gradient-to-r from-[#8059ca] to-[#9d72e8] text-white text-xs font-bold rounded-xl border-0 cursor-pointer shadow-md shadow-purple-200 hover:shadow-lg transition-all"
                              onClick={() => handleTabChange("recipient-details")}
                            >
                              Next: Tag Address
                            </button>
                        ...
                        <form onSubmit={handleSaveAddress} className="flex flex-col">
                              ...
                              {[
                                ...
                                <button
                                  ...
                                  className={`px-3 py-1.5 border border-solid rounded-xl text-xs font-semibold cursor-pointer transition-all flex items-center gap-1.5 flex-1 min-w-[calc(50%-4px)] justify-center ${formData.addressType === item.key
                                    ? "border-[#8059ca] bg-[#8059ca] text-white shadow-md shadow-purple-100"
                          ...
                          {formData.addressType === "other" && (
                            <div className="mb-2">
                              <input
                                type="text"
                                className="w-full p-[9px_12px] border border-solid border-slate-200 rounded-xl text-xs bg-white focus:border-[#8059ca] focus:ring-2 focus:ring-purple-100 transition-all outline-none"
            ...
            >
              {loadError ? (
                ...
                <div style={{ position: "relative", height: "100%" }}>
                  ...
                  <button
                    type="button"
                    className="absolute bg-[#8059ca] hover:bg-[#6b42b8] text-white rounded-full w-[44px] h-[44px] flex items-center justify-center cursor-pointer shadow-md transition-all z-[1000]"
                    style={{
                      top: "12px",
                      right: "12px",
                    }}
              ...
              <div className="p-5 flex flex-col h-full justify-between">
                <div className="flex justify-between items-center mb-4">
                  <h5 className="text-base font-bold text-slate-800 mb-0 flex items-center gap-2">
                    <span className="w-2.5 h-2.5 rounded-full bg-[#8059ca]"></span>
                          ...
                          <div className="flex items-center">
                              ...
                              {isLoaded ? (
                                ...
                                >
                                  <input
                                    ...
                                    type="text"
                                    disabled={!locationChange}
                                    className="w-full h-[36px] p-[0_12px_0_36px] border border-solid border-r-0 border-slate-200 rounded-l-xl text-xs bg-white focus:border-[#8059ca] focus:ring-2 focus:ring-purple-100 transition-all outline-none"
                            ...
                            <button
                              ...
                              className={`px-3.5 !rounded-r-xl text-xs font-semibold border border-solid cursor-pointer transition-colors ${locationChange
                                ? "bg-[#8059ca] hover:bg-[#6b42b8] border-[#8059ca] text-white"
                                : "bg-[#f3ecff] text-[#8059ca] border-slate-200 hover:bg-[#e7daff] hover:border-[#8059ca]"
                                }`}
                              style={{ height: "36px", minWidth: "70px" }}
                            >
                              {locationChange ? "Lock" : "Edit"}
                  ...
                  {activeTab === "recipient-details" && (
                    <form onSubmit={handleSaveAddress} className="flex flex-col h-full justify-between">
                      ...
                      <div className="mt-6">
                        <button
                          type="submit"
                          className="w-full py-2.5 bg-gradient-to-r from-[#8059ca] to-[#9d72e8] hover:from-[#6b42b8] hover:to-[#8c60d5] text-white text-xs font-bold rounded-xl border-0 cursor-pointer shadow-md shadow-purple-200 hover:shadow-lg transition-all flex items-center justify-center gap-1.5"
                          disabled={isSubmitting}
                        >
                          {isSubmitting ? (
                            <>
