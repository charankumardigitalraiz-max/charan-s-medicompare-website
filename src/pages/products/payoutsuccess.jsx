      ...
      <div className="fixed inset-0 z-[99999] bg-black/60 backdrop-blur-sm p-4 overflow-y-auto flex justify-center items-center md:relative md:inset-auto md:z-auto md:bg-transparent md:backdrop-blur-none md:overflow-visible md:py-16 md:px-4">
        <div className="w-full max-w-[400px] my-auto">
          <div className="bg-white rounded-[24px] shadow-[0_20px_60px_rgba(128,89,202,0.15)] overflow-hidden">
            ...
            {/* Top accent strip */}
            <div className="h-[6px] bg-gradient-to-r from-[var(--color-primary,#4c2691)] to-[#04BD6C]" />
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="bg-[#f8f5fe] rounded-[16px] p-3 md:p-6 mb-6 border border-[#e8d5ff]">
                <div className="flex items-center gap-2 mb-4 pb-3 border-b border-[#e0c8ff]">
                  <i className="fas fa-receipt text-[var(--color-primary,#4c2691)]" />
                ...
                <div className="space-y-3.5">
                  <div className="flex justify-between items-center gap-4">
                    <span className="flex items-center gap-2 text-[13px] md:text-sm text-[#666] shrink-0">
                      <i className="fas fa-hashtag text-[var(--color-primary,#4c2691)]" /> Order ID
                    </span>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="flex items-center gap-2 text-[13px] md:text-sm text-[#666]">
                      <i className="fas fa-calendar-alt text-[var(--color-primary,#4c2691)]" /> Order Date
                    </span>
                    <span className="text-[13px] md:text-sm font-semibold text-[#333]">{currentDate}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="flex items-center gap-2 text-[13px] md:text-sm text-[#666]">
                      <i className="fas fa-check-circle text-[var(--color-primary,#4c2691)]" /> Status
                    </span>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-md mx-auto">
                <Link
                  to={viewOrdersLink}
                  className="flex-1 flex items-center justify-center gap-2 !bg-[var(--color-primary,#4c2691)] hover:!bg-[#6b44b8] !text-white !text-[13px] md:!text-[15px] !font-semibold py-2 px-4 !rounded-[10px] transition-all duration-200 !no-underline whitespace-nowrap"
                >
                ...
                <Link
                  to="/"
                  className="flex-1 flex items-center justify-center gap-2 !bg-white hover:!bg-[#f5f0ff] !text-[var(--color-primary,#4c2691)] border border-[var(--color-primary,#4c2691)] !text-[13px] md:!text-[15px] !font-semibold py-2 px-4 !rounded-[10px] transition-all duration-200 !no-underline whitespace-nowrap"
                >
