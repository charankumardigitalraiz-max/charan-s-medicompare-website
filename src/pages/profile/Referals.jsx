      ...
      <div className="!py-4 md:!py-6">
        <div className="!max-w-7xl !mx-auto !px-4 sm:!px-6 lg:!px-8">
          <div className="!flex !flex-col !gap-5">
            ...
            {/* Referral Card */}
            <div className="!bg-gradient-to-br !from-[var(--color-primary,#4c2691)] !to-[var(--color-primary-dark,#5c33a6)] !text-white !rounded-[9px] !p-6 !text-center !shadow-md">
              ...
              <div className="!bg-white/15 !p-4 !rounded-lg !mb-4">
                ...
                <div className="!flex !justify-center !items-center !gap-3">
                  <div className="!bg-white !text-[var(--color-primary,#4c2691)] !py-2 !px-4 !rounded-md !font-bold !text-lg !tracking-wider !shadow-sm">
                    {profile?.refferalcode}
                  </div>
                  <button
                    onClick={handleCopyLink}
                    className="!bg-white !text-[var(--color-primary,#4c2691)] !border-0 !py-2.5 !px-4 !rounded-md !font-bold !cursor-pointer !flex !items-center !gap-1.5 !shadow-sm !transition-all !duration-200 hover:!bg-purple-50"
                  >
              ...
              <button
                onClick={handleShare}
                className="!bg-white !text-[var(--color-primary,#4c2691)] !border-0 !py-3 !px-6 !rounded-[30px] !font-bold !cursor-pointer !inline-flex !items-center !gap-2 !text-sm !shadow-md !transition-all !duration-300 hover:!-translate-y-0.5 hover:!shadow-lg"
              >
              ...
              <div className="!flex !flex-col !gap-4">
                {[
                  ...
                  <div key={index} className="!flex !gap-4 !items-start">
                    <div className="!bg-purple-50 !text-[var(--color-primary,#4c2691)] !w-8 !h-8 !rounded-full !flex !items-center !justify-center !shrink-0 !font-bold !text-sm !border !border-purple-100/50">
                      {item.step}
                    </div>
                    <div>
