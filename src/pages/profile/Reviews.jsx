          ...
          <div className="flex justify-between items-start">
            <div className="flex items-center gap-2">
              {userAvatar ? (
                ...
                <div className="w-10 h-10 rounded-full bg-[var(--color-primary,#4c2691)] text-white flex items-center justify-center text-xl uppercase shrink-0">
      ...
      <div className="max-w-[1200px] mx-auto p-[15px]">
        <div className="text-center py-10 px-5 text-red-600">
          ...
          <button
            ...
            className="py-2 px-4 rounded-md bg-[var(--color-primary,#4c2691)] hover:bg-[var(--color-primary-dark,#5c33a6)] text-white border-none cursor-pointer text-[13px] font-medium transition-colors duration-200"
          >
            Try Again
          </button>
        </div>
