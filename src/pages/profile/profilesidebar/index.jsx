              ...
              {profile?.image ? (
                <img
                  ...
                  style={{
                    ...
                    objectFit: "cover",
                    border: "2.5px solid var(--color-primary,#4c2691)",
                ...
                <div
                  ...
                  style={{
                    width: isMobile ? "64px" : "72px",
                    height: isMobile ? "64px" : "72px",
                    background: "linear-gradient(135deg, var(--color-primary,#4c2691) 0%, var(--color-primary-dark,#5c33a6) 100%)",
                    color: "#ffffff",
                    fontWeight: "700",
              ...
              return (
                <li key={item.id} className="nav-item">
                  <Link
                    ...
                    style={{
                      color: isActive ? "var(--color-primary,#4c2691)" : "#4a5568",
                  ...
                  >
                    <i
                      className={`${item.icon} mr-3 transition-colors duration-200 ${isActive ? "!text-[var(--color-primary,#4c2691)]" : "!text-slate-400 group-hover:!text-[var(--color-primary,#4c2691)]"}`}
  ...
  return (
    <div className="main-wrapper">
      ...
      <button
        ...
        className="lg:hidden fixed bottom-20 right-6 w-12 h-12 !rounded-[20px] bg-gradient-to-br from-[var(--color-primary,#4c2691)] to-[var(--color-primary-dark,#5c33a6)] text-white border border-white/20 flex items-center justify-center cursor-pointer shadow-[0_8px_20px_rgba(128,89,202,0.35)] transition-all duration-300 z-[99999] hover:scale-105 active:scale-95"
