                          ...
                          <div className="!flex !flex-col !flex-grow !p-[10px] !gap-[6px]">
                            ...
                            {medicine?.reportsDuration && (
                              <p className="!m-0 !flex !items-center !gap-[5px] !text-[10px] !text-[#444]">
                                <i className="fa-regular fa-file-lines !text-[var(--color-primary,#4c2691)]"></i>
                                ...
                                >
                                  ...
                                  <div className="!flex-1 !min-w-0">
                                    ...
                                    <div className="!flex !items-center !gap-[4px] !text-[10px] !text-[#444] !mt-[1px]">
                                      <i className="fa-solid fa-location-dot !text-[var(--color-primary,#4c2691)] !text-[10px]"></i>
                                    ...
                                    {test?.distanceInKm && (
                                      <div className="!flex !items-center !gap-[3px] !text-[10px] !text-[#666] !mt-[1px]">
                                        <i className="isax isax-route-square !text-[var(--color-primary,#4c2691)] !text-[10px]"></i>
      ...
      <div className="!my-6 !py-2 !px-4">
        <div className="!grid !grid-cols-1 md:!grid-cols-2 !gap-4">
          ...
          <div className="!flex !items-center !gap-4 !p-4 !rounded-[14px] !bg-gradient-to-br !from-[#F8F5FE] !to-[#F2EDFE] !border !border-[rgba(125,46,255,0.12)] !cursor-pointer !transition-all !duration-300 hover:!-translate-y-[3px] hover:!shadow-[0_6px_20px_rgba(125,46,255,0.15)] hover:!border-[rgba(125,46,255,0.3)]">
            {/* Icon */}
            <div className="!relative !shrink-0 !w-[70px] !h-[70px] !bg-gradient-to-br !from-[var(--color-primary,#4c2691)] !to-[#822BD4] !rounded-[16px] !shadow-[0_4px_12px_rgba(125,46,255,0.3)] !flex !items-center !justify-center">
            ...
            {/* Arrow */}
            <div className="!shrink-0 !w-[44px] !h-[44px] !rounded-[12px] !flex !items-center !justify-center !transition-all !duration-300 hover:!scale-110" style={{ background: "linear-gradient(135deg, var(--color-primary,#4c2691) 0%, #822BD4 100%)", boxShadow: "0 3px 10px rgba(125,46,255,0.3)" }}>
          ...
          <div className="!flex !flex-col lg:!flex-row !items-center !gap-8">
            ...
            <div className="lg:!w-[260px] !shrink-0 !text-center lg:!text-left">
              <h3 className="!m-0 !text-[26px] !font-bold !leading-[1.3] !text-[#1a1a1a]">
                ...
                <span className="!text-[var(--color-primary,#4c2691)]">in 3 simple steps</span>
              </h3>
            </div>
            ...
            <div className="!flex-1 !grid !grid-cols-1 md:!grid-cols-3 !gap-6 !relative">
              ...
              <div className="!relative !flex !flex-col !items-center !text-center">
                <span className="!inline-block !mb-3 !px-[20px] !py-[7px] !rounded-full !text-[11px] !font-semibold !text-white !tracking-wide" style={{ background: "linear-gradient(135deg, var(--color-primary,#4c2691) 0%, #822BD4 100%)", boxShadow: "0 4px 12px rgba(125,46,255,0.3)" }}>STEP 1</span>
                <div className="!w-[110px] !h-[110px] !mb-3 !flex !items-center !justify-center !relative !rounded-[24px] !transition-all !duration-300 hover:!-translate-y-[5px] hover:!shadow-[0_12px_32px_rgba(125,46,255,0.3)]" style={{ background: "linear-gradient(135deg, #F8F5FE 0%, #F2EDFE 100%)", boxShadow: "0 8px 24px rgba(125,46,255,0.2)" }}>
                  <i className="isax isax-mobile" style={{ fontSize: "50px", background: "linear-gradient(135deg,var(--color-primary,#4c2691),#822BD4)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}></i>
                ...
                {/* Connector */}
                <div className="!hidden md:!block !absolute !top-[52px] !right-[-28px] !w-[52px] !h-[3px] !rounded-[2px] !z-10" style={{ background: "linear-gradient(90deg, var(--color-primary,#4c2691), #04BD6C)" }}>
      ...
      <section className="!py-8 !bg-white !relative !overflow-hidden">
        ...
        <div className="!relative !z-10 !max-w-7xl !mx-auto !px-4">
          ...
          <div className="!grid !grid-cols-2 md:!grid-cols-3 lg:!grid-cols-5 !gap-4">
            ...
            <div className="!group !flex !flex-col !items-center !text-center !p-6 !bg-white !rounded-[16px] !border !border-[#e9ecef] !shadow-[0_2px_8px_rgba(0,0,0,0.05)] !cursor-pointer !transition-all !duration-300 hover:!-translate-y-[5px] hover:!shadow-[0_8px_20px_rgba(125,46,255,0.15)] hover:!border-[var(--color-primary,#4c2691)]">
            ...
            <div className="!group !col-span-2 md:!col-span-1 !flex !flex-col !items-center !text-center !p-6 !bg-white !rounded-[16px] !border !border-[#e9ecef] !shadow-[0_2px_8px_rgba(0,0,0,0.05)] !cursor-pointer !transition-all !duration-300 hover:!-translate-y-[5px] hover:!shadow-[0_8px_20px_rgba(125,46,255,0.15)] hover:!border-[var(--color-primary,#4c2691)]">
              <div className="!w-[90px] !h-[90px] !mb-4 !flex !items-center !justify-center !bg-white !rounded-full !border-[2px] !border-[var(--color-primary,#4c2691)] !shadow-[0_2px_8px_rgba(125,46,255,0.15)] !relative !shrink-0">
                <div className="!relative !w-[60px] !h-[60px]">
                  <div style={{ width: "52px", height: "52px", background: "var(--color-primary,#4c2691)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", position: "absolute", top: "50%", left: "50%", transform: "translate(-50%,-50%)", boxShadow: "0 2px 8px rgba(125,46,255,0.3)" }}>
                    <span style={{ fontSize: "26px", fontWeight: "700", color: "#fff" }}>%</span>
                  </div>
                  <div style={{ position: "absolute", top: "-5px", left: "-5px", width: "70px", height: "70px", border: "2px solid var(--color-primary,#4c2691)", borderRadius: "50%", opacity: 0.35 }}></div>
                </div>
              </div>
