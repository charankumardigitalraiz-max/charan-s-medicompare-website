                                ...
                                <div className="!grow !min-w-0">
                                  ...
                                  {treatment?.distanceInKm && (
                                    <div className="!flex !items-center !gap-1 !text-[#6b7280] !text-[11px]">
                                      <i className="fas fa-map-marker-alt !text-[10px] !text-[var(--color-primary,#4c2691)]"></i>
      ...
      >
        <div className="!max-w-7xl !mx-auto !px-4">
          <div className="!text-center !mb-8">
            <h2 className="!m-0 !text-[36px] !font-semibold !bg-gradient-to-r !from-[var(--color-primary,#4c2691)] !to-[#6d48b8] !bg-clip-text !text-transparent !tracking-tight">
              How It Works
            </h2>
          ...
          <div className="!flex !flex-col md:!flex-row !items-center !justify-between !gap-6 !mt-6">
            ...
            <div className="!flex-1 !w-full !text-center">
              <div className="!flex !flex-col !items-center">
                <div
                  ...
                  className="!w-[90px] !h-[90px] !rounded-full !bg-[var(--color-primary,#4c2691)] !flex !items-center !justify-center !relative !border-[4px] !border-[rgba(128,89,202,0.2)] !transition-all !duration-300 hover:!-translate-y-1 hover:!shadow-[0_10px_30px_rgba(128,89,202,0.4)]"
                >
                ...
                <h5 className="!mt-4 !mb-2 !text-[16px] !font-bold !text-[var(--color-primary,#4c2691)]">
            ...
            <div className="!hidden md:!flex !items-center !justify-center">
              <i className="fa fa-arrow-right !text-[24px] !text-[var(--color-primary,#4c2691)] !opacity-30"></i>
            </div>
              ...
              {nursingOfferProducts?.slice(0, 8).map((ele, ind) => {
                return (
                  <div key={ind} className="!w-full">
                    <div
                      className="!relative !h-[220px] !rounded-[16px] !overflow-hidden !cursor-pointer !border !border-[rgba(128,89,202,0.08)] !shadow-[0_4px_20px_rgba(128,89,202,0.06)] !transition-all !duration-300 hover:!-translate-y-1 hover:!shadow-[0_12px_30px_rgba(128,89,202,0.25)] hover:!border-[var(--color-primary,#4c2691)]"
          ...
          <div className="!grid !grid-cols-1 md:!grid-cols-2 lg:!grid-cols-3 !gap-6">
            {[
              ...
              <div key={index} className="!w-full !flex">
                <div
                  className="!flex !flex-col !w-full !p-6 !bg-white !rounded-[16px] !shadow-[0_6px_16px_rgba(128,89,202,0.06)] !border !border-[rgba(128,89,202,0.1)] !transition-all !duration-300 hover:!-translate-y-1 hover:!shadow-[0_12px_24px_rgba(128,89,202,0.12)] hover:!border-[var(--color-primary,#4c2691)]"
                >
                  {/* Top content wrapper */}
                  <div className="!flex !justify-between !items-start !mb-4">
                    ...
                    <div className="!flex !gap-[3px]">
                      {Array.from({ length: testimonial.stars }).map((_, starIdx) => (
                        <i
                          key={starIdx}
                          className="fa fa-star !text-[var(--color-primary,#4c2691)] !text-[13px]"
                        ></i>
                      ))}
                    </div>
                    ...
                    <div className="!w-8 !h-8 !rounded-full !bg-[#f8f4ff] !flex !items-center !justify-center !opacity-80">
                      <i className="fa fa-quote-right !text-[var(--color-primary,#4c2691)] !text-[14px]"></i>
                    </div>
                  </div>
                  ...
                  <div className="!flex !items-center !gap-3 !mt-auto">
                    <div className="!w-11 !h-11 !rounded-full !bg-[var(--color-primary,#4c2691)] !flex !items-center !justify-center !text-white !text-[15px] !font-bold !shrink-0">
          ...
          <div className="!grid !grid-cols-2 md:!grid-cols-4 !gap-6 !mt-10 !pt-8 !border-t-2 !border-[rgba(128,89,202,0.2)]">
            {[
              ...
              <div key={idx} className="!text-center">
                <div className="!text-[36px] !font-bold !text-[var(--color-primary,#4c2691)] !mb-1 !tracking-tight">
                  {stat.value}
                </div>
