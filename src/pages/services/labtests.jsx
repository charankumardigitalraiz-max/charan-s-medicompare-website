        ...
        >
          <div className="container-fluid px-3">
            <div className="!flex !items-center !justify-center !flex-wrap gap-3 !mb-4 !relative">
              ...
              >
                <Link
                  ...
                  className={`inline-flex items-center justify-center !font-semibold !text-[12px] !text-[var(--color-primary,#4c2691)] hover:!bg-[var(--color-primary-dark,#5c33a6)] hover:!text-white transition-all duration-300 !rounded-[50px] !w-auto !h-auto bg-gradient-to-br from-[rgba(125,46,255,0.1)] to-[rgba(59,130,246,0.1)] ${isMobile ? "!py-[6px] !px-[18px]" : "!py-[8px] !px-[20px]"
                    }`}
                  onClick={(e) => {
                    if (!isLoggedIn) {
                      e.preventDefault();
            ...
            {packages && packages.length > 0 && compareItems.length > 0 && (
              <div
                className={`!relative !mx-auto !my-[16px] !bg-[var(--color-primary,#4c2691)] !rounded-[12px] !shadow-[0_6px_20px_rgba(128,89,202,0.3)] !z-10 !mb-4 ${isMobile
                          ...
                          >
                            ...
                            >
                              ...
                              {pkg?.files?.[0] ? (
                                ...
                                >
                                  <div
                                    className="!w-[70px] !h-[70px] !border-2 !border-solid !border-[var(--color-primary,#4c2691)] !rounded-[10px] !flex !flex-col !items-center !justify-center !bg-white !p-[12px]"
                                  >
                                    <i
                                      className="isax isax-health !text-[35px] !text-[var(--color-primary,#4c2691)]"
                                    ></i>
                                    <span
                                      className="!text-[9px] !text-[var(--color-primary,#4c2691)] !font-semibold !mt-[6px] !tracking-[0.5px]"
                                    >
                                      PACKAGE
                                    </span>
                                  </div>
                            ...
                            >
                              ...
                              >
                                <div
                                  className="!flex !items-center !gap-1 !shrink-0 !bg-[#F8F5FE] !py-[3px] !px-[6px] !rounded-[5px] !border !border-solid !border-[var(--color-primary,#4c2691)]/20"
                                >
                                  <i
                                    className="isax isax-profile-2user !text-[12px] !text-[var(--color-primary,#4c2691)]"
                                  ></i>
                                  <span
                                    ...
                                    >
                                      ...
                                      {pkg?.vendor?.businessDetails
                                        ?.address && (
                                          ...
                                          >
                                            <i
                                              className="isax isax-location !text-[12px] !text-[var(--color-primary,#4c2691)]"
                                            ></i>
                                            <span
                                      ...
                                      {pkg?.vendor?.distanceInKm && (
                                        ...
                                        >
                                          <i
                                            className="fas fa-map-marker-alt !text-[var(--color-primary,#4c2691)] !text-[10px] !mr-[4px]"
                                          ></i>
                                          <span
                                            className="!text-dark !overflow-hidden !text-ellipsis !whiteSpace-nowrap"
                                          >
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <i
                                  className="fa-regular fa-file-lines !text-[var(--color-primary,#4c2691)] !text-[10.5px] !mr-1"
                                />{" "}
                                Reports in
                                <strong
                                  className="!text-[#333] !ml-[2px]"
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    >
                                      ...
                                      >
                                        <i
                                          className="fa-solid fa-location-dot !text-[11px] !text-[var(--color-primary,#4c2691)]"
                                        ></i>
                                        <span
                                      ...
                                      >
                                        <i
                                          className="fas fa-map-marker-alt !text-[10px] !text-[var(--color-primary,#4c2691)] !mr-[4px]"
                                        ></i>
      ...
      >
        <div className="container-fluid !px-4 md:!px-6 lg:!px-8 !py-4 lg:!py-10">
          <div className="!text-center !rounded-[20px] !p-[10px_12px_12px] !mt-[10px]">
            <div className="!inline-flex !items-center !gap-2 !mb-[12px] !mx-auto !px-4 !py-[6px] !rounded-full !bg-[rgba(128,89,202,0.12)] !text-[var(--color-primary,#4c2691)] !text-[12px] !font-semibold !tracking-wide !border !border-[rgba(128,89,202,0.25)]">
                ...
                >
                  {[
                    ...
                    <SwiperSlide key={index} style={{ height: "auto", display: "flex" }}>
                      ...
                      >
                        <span
                          className="!absolute !top-[16px] !right-[16px] !bg-[rgba(128,89,202,0.08)] !text-[var(--color-primary,#4c2691)] !py-[4px] !px-[10px] !rounded-[20px] !text-[11px] !font-bold !tracking-[0.05em]"
                        >
                          {item.step}
                        </span>
                        <div
                        ...
                        >
                          <i className={item.icon} style={{ fontSize: "26px", color: "var(--color-primary,#4c2691)" }} />
                        </div>
                        <h5
              ...
              <div className="!grid !grid-cols-1 md:!grid-cols-3 !gap-4 !items-stretch">
                {[
                  ...
                  <div key={index} className="w-full">
                    <div
                      className="!text-center !h-full !relative !p-[32px_20px_24px] !bg-white !rounded-[16px] !border !border-solid !border-[#e2e8f0] !shadow-[0_4px_12px_rgba(128, 89, 202, 0.02)] transition-all duration-300 ease-out !cursor-pointer hover:!-translate-y-[6px] hover:!shadow-[0_12px_24px_rgba(128, 89, 202, 0.08)] hover:!border-[var(--color-primary,#4c2691)]"
                    >
                      <span
                        className="!absolute !top-[16px] !right-[16px] !bg-[rgba(128,89,202,0.08)] !text-[var(--color-primary,#4c2691)] !py-[4px] !px-[10px] !rounded-[20px] !text-[11px] !font-bold !tracking-[0.05em]"
                      >
          ...
          {isMobile ? (
            <div className="!px-[10px]">
              ...
              >
                {[
                  ...
                  <SwiperSlide key={index} style={{ height: "auto", display: "flex" }}>
                    <div
                      className="!bg-white !rounded-[16px] !p-[24px_16px] !h-full !border !border-solid !border-[var(--color-primary,#4c2691)]/12 !flex !flex-col !shadow-[0_4px_15px_rgba(128, 89, 202, 0.03)] !w-full"
                    >
                      <div
                        className="!w-[48px] !h-[48px] !rounded-full !bg-[#f3effa] !flex !items-center !justify-center !mb-[16px] !text-[var(--color-primary,#4c2691)] !text-[20px]"
                      >
            ...
            <div className="!grid !grid-cols-1 md:!grid-cols-2 lg:!grid-cols-3 !gap-4">
              {[
                ...
                >
                  <div
                    className="!bg-white !rounded-[16px] !p-[24px] !h-full !border !border-solid !border-[var(--color-primary,#4c2691)]/12 transition-all duration-300 ease-out !cursor-pointer !flex !flex-col !shadow-[0_4px_15px_rgba(128,89,202,0.03)] hover:!-translate-y-[6px] hover:!shadow-[0_10px_25px_rgba(128,89,202,0.08)] hover:!border-[var(--color-primary,#4c2691)]"
                  >
                    <div
                      className="!w-[48px] !h-[48px] !rounded-full !bg-[#f3effa] !flex !items-center !justify-center !mb-[16px] !text-[var(--color-primary,#4c2691)] !text-[20px]"
                    >
          ...
          {isMobile ? (
                ...
                {[
                  {
                    ...
                    icon: <i className="fa-solid fa-shield-halved" style={{ fontSize: "24px", color: "var(--color-primary,#4c2691)" }}></i>
                  },
                  {
                    title: "Online Reports",
                    desc: "You can download your reports online",
                    icon: <i className="fa-solid fa-file-invoice" style={{ fontSize: "24px", color: "var(--color-primary,#4c2691)" }}></i>
                  },
                  {
                    title: "Home Sample Collection",
                    desc: "Our expert phlebotomists will come and collect your sample",
                    icon: <i className="fa-solid fa-house-chimney-medical" style={{ fontSize: "24px", color: "var(--color-primary,#4c2691)" }}></i>
                  },
                  {
                    title: "MediCompares Advantage",
                    desc: "Enjoy upto 75% discount on diagnostic tests and health packages",
                    icon: <i className="fa-solid fa-award" style={{ fontSize: "24px", color: "var(--color-primary,#4c2691)" }}></i>
                  },
                  {
                    title: "Competitive Prices",
                    desc: "We offer best prices on our diagnostic tests and health packages",
                    icon: <i className="fa-solid fa-tags" style={{ fontSize: "24px", color: "var(--color-primary,#4c2691)" }}></i>
                  }
                ].map((practice, index) => (
                  <SwiperSlide key={index} style={{ height: "auto", display: "flex" }}>
                    <div
            ...
            >
              {[
                ...
                >
                  <div
                    className="!text-center !h-full !p-[24px_16px] !bg-white !rounded-[16px] !border !border-solid !border-[#e2e8f0] !shadow-[0_4px_12px_rgba(128, 89, 202, 0.02)] transition-all duration-300 ease-out !cursor-pointer hover:!-translate-y-[6px] hover:!shadow-[0_12px_24px_rgba(128, 89, 202, 0.08)] hover:!border-[var(--color-primary,#4c2691)]"
                  >
                    <div
        ...
        showDiscountPopup && (
          ...
          `}</style>
            <div
              style={{
                background:
                  "linear-gradient(135deg, var(--color-primary,#4c2691) 0%, #822BD4 50%, #A855F7 100%)",
                borderRadius: "18px",
                padding: "20px",
