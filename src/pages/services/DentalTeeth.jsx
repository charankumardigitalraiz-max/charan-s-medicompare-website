                          ...
                          <div className="!flex !flex-col !flex-grow !p-[10px] !gap-[6px]">
                            ...
                            <div className="!flex !flex-col !gap-[3px]">
                              <p className="!m-0 !flex !items-center !gap-[5px] !text-[10px] !text-[#444] !capitalize">
                                <i className="fas fa-procedures !text-[var(--color-primary,#4c2691)] !w-[12px]"></i>
                                <span>Treatment:</span>
                                <strong>{medicine?.treatmenttype}</strong>
                              </p>
                              <p className="!m-0 !flex !items-center !gap-[5px] !text-[10px] !text-[#444]">
                                <i className="fas fa-clock !text-[var(--color-primary,#4c2691)] !w-[12px]"></i>
                                <span>Duration:</span>
                                <strong>30–90 mins</strong>
                              </p>
                              <p className="!m-0 !flex !items-center !gap-[5px] !text-[10px] !text-[#444]">
                                <i className="fas fa-user-md !text-[var(--color-primary,#4c2691)] !w-[12px]"></i>
            ...
            {stats.map((stat, idx) => (
              ...
              >
                <div
                  ...
                  style={{ background: "linear-gradient(135deg, var(--color-primary,#4c2691), #a07dd8)" }}
                >
                  <i
                ...
                <div>
                  <h3 className="!m-0 !font-bold !text-[24px] !leading-none !text-[var(--color-primary,#4c2691)]">
