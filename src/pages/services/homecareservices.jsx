                            ...
                            >
                              ...
                              <div className="!grow !min-w-0">
                                ...
                                <div className="!flex !items-center !gap-1 !text-[#6b7280] !text-[10px] !overflow-hidden">
                                  <i className="fa-solid fa-location-dot !text-[10px] !text-[var(--color-primary,#4c2691)]"></i>
                                  <span className="!truncate">{vendor.address}</span>
                                </div>
                                {treatment?.distanceInKm && (
                                  <div className="!flex !items-center !gap-1 !text-[#6b7280] !text-[10px]">
                                    <i className="fas fa-map-marker-alt !text-[9px] !text-[var(--color-primary,#4c2691)]"></i>
        ...
        <div className="!max-w-7xl !mx-auto !px-4">
          <div className="!flex !flex-col lg:!flex-row !items-center !gap-8">
            ...
            <div className="lg:!w-5/12 !text-center lg:!text-left">
              <span className="!text-[12px] !font-semibold !text-[var(--color-primary,#4c2691)] !tracking-wider !uppercase">Simple booking process</span>
              <h2 className="!mt-2 !text-[32px] !font-bold !text-[#1a1a1a] !leading-tight">
                How it <span className="!text-[var(--color-primary,#4c2691)]">Works &amp; Booking</span>
              </h2>
            ...
            <div className="lg:!w-7/12 !w-full">
              ...
              <div className="!hidden md:!grid !grid-cols-4 !gap-4 !relative">
                ...
                <div className="!flex !flex-col !items-center !text-center !p-4 !bg-white !rounded-[16px] !shadow-[0_4px_16px_rgba(0,0,0,0.05)] !relative">
                  ...
                  <span className="!absolute !bottom-2 !right-3 !text-[11px] !font-bold !text-[var(--color-primary,#4c2691)] !opacity-30">01</span>
                </div>
                ...
                <div className="!flex !flex-col !items-center !text-center !p-4 !bg-white !rounded-[16px] !shadow-[0_4px_16px_rgba(0,0,0,0.05)] !relative">
                  ...
                  <span className="!absolute !bottom-2 !right-3 !text-[11px] !font-bold !text-[var(--color-primary,#4c2691)] !opacity-30">02</span>
                </div>
                ...
                <div className="!flex !flex-col !items-center !text-center !p-4 !bg-white !rounded-[16px] !shadow-[0_4px_16px_rgba(0,0,0,0.05)] !relative">
                  ...
                  <span className="!absolute !bottom-2 !right-3 !text-[11px] !font-bold !text-[var(--color-primary,#4c2691)] !opacity-30">03</span>
                </div>
                ...
                <div className="!flex !flex-col !items-center !text-center !p-4 !bg-white !rounded-[16px] !shadow-[0_4px_16px_rgba(0,0,0,0.05)] !relative">
                  ...
                  <span className="!absolute !bottom-2 !right-3 !text-[11px] !font-bold !text-[var(--color-primary,#4c2691)] !opacity-30">04</span>
                </div>
              ...
              <div className="md:!hidden !flex !flex-col !gap-3 !mt-4">
                {MOBILE_BOOKING_STEPS.map((item) => (
                  <div key={item.step} className="!flex !items-center !gap-4 !p-4 !bg-white !rounded-[14px] !shadow-[0_2px_8px_rgba(0,0,0,0.05)] !border !border-[rgba(128,89,202,0.1)]">
                    <div className="!w-[44px] !h-[44px] !rounded-[10px] !bg-[#f8f6fc] !flex !items-center !justify-center !shrink-0 !border !border-[var(--color-primary,#4c2691)]">
                      <img src={item.icon} alt="" className="!w-[22px] !h-[22px]" />
                    </div>
                    <div className="!grow">
                      <span className="!text-[10px] !font-bold !text-[var(--color-primary,#4c2691)] !uppercase">Step {item.step}</span>
      ...
      >
        <div className="!max-w-7xl !mx-auto !px-4">
          ...
          <div className="!text-center !mb-8">
            <h2 className="!text-[38px] !font-semibold !bg-gradient-to-r !from-[var(--color-primary,#4c2691)] !to-[#5d3ebc] !bg-clip-text !text-transparent !tracking-tight">
              ...
              {[
                ...
                >
                  <div className="!flex !items-center !gap-3">
                    ...
                    <div>
                      <span className="!block !text-[10px] !font-bold !text-[var(--color-primary,#4c2691)] !uppercase !tracking-wider">
                        {card.phase}
                      </span>
            ...
            {[
              ...
              return (
                <div key={index} className="!w-full">
                  <div
                    className="!group !relative !p-5 !bg-white !rounded-[12px] !border !border-[#f0f0f0] !h-full !overflow-hidden !transition-all !duration-300 hover:!-translate-y-[4px] hover:!shadow-[0_12px_24px_rgba(0,0,0,0.1)] hover:!border-[var(--color-primary,#4c2691)]"
                  >
                ...
                >
                  <h2>
                    ...
                    >
                      ...
                      <i className={`fas fa-chevron-${isOpen ? "up" : "down"} !text-[12px] !text-[var(--color-primary,#4c2691)]`}></i>
                    </button>
                  </h2>
