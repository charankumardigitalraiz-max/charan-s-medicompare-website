                      ...
                      >
                        <div className="!relative !w-full !h-[180px] !bg-white !rounded-t-[16px] !overflow-hidden">
                          ...
                          <div
                            ...
                            className="!absolute !top-2 !left-2 !p-[6px_10px] !rounded-full !shadow-[0_2px_8px_rgba(0,0,0,0.15)] !text-[13px] !cursor-pointer !bg-[var(--color-primary,#4c2691)] !text-white !transition-all hover:!scale-110 !z-10"
                          >
                          ...
                          <div className="!rounded-[8px] !p-[8px] !mt-auto !border !border-[rgba(128,89,202,0.15)] !bg-primary-bg">
                            ...
                            {Number(item?.perDayRent || 0) > 0 && (
                              <>
                                ...
                                <div className="!flex !items-center !gap-[6px] !text-[11px] !text-[var(--color-primary,#4c2691)] !mt-[4px] !font-medium">
