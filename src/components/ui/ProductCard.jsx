      ...
      <div className="!flex !flex-col !gap-[2px] !pt-2 !mt-auto">
        ...
        >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-0.5 px-2 !rounded-md !text-[13px] !font-semibold !text-white bg-[var(--color-primary,#4c2691)] shadow-sm shadow-[var(--color-primary,#4c2691)]/20 hover:shadow-md transition-all duration-300 cursor-pointer border-none"
          >
