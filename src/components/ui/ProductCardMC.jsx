      ...
      <div className="!flex !flex-col !gap-[2px] !pt-2 !mt-auto">
        ...
        >
              ...
              <div className="flex items-center gap-2">
                <div className="!w-[32px] !h-[32px] sm:!w-[45px] sm:!h-[45px] !rounded-[6px] sm:!rounded-[8px] !overflow-hidden !bg-[#f8fafc] !border !border-solid !border-[#f1f5f9] !shrink-0 !flex !items-center !justify-center">
                  {vendorImage ? (
                    ...
                    <div className="!w-full !h-full !bg-gradient-to-br !from-[var(--color-primary,#4c2691)] !to-[var(--color-primary,#4c2691)] !text-white !flex !items-center !justify-center !font-bold !text-[12px]">
                      {vendorName.charAt(0)}
                    </div>
                  )}
                </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 py-0.5 px-2 !rounded-md !text-[13px] !font-semibold !text-white bg-[var(--color-primary,#4c2691)] hover:bg-[var(--color-primary-dark,#5c33a6)] shadow-sm shadow-[var(--color-primary,#4c2691)]/20 hover:shadow-md transition-all duration-300 cursor-pointer border-none"
          >
