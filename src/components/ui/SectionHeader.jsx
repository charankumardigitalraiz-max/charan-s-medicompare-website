...
const SectionHeader = ({
  ...
  const renderViewAllButton = () => {
    const buttonClasses = `inline-flex items-center justify-center !font-bold !text-[14px] !text-[#8059ca] hover:!bg-[#8059ca] hover:!text-white transition-all duration-300 ${
      isMobile
        ? "!p-0 !rounded-full !w-[36px] !h-[36px] !shrink-0 !grow-0 !self-center !bg-[#8059ca]/10"
  ...
  return (
    ...
    >
      <div
        className="inline-block py-[4px] px-[10px] bg-gradient-to-br from-[#8059ca]/10 to-[#8059ca]/20 rounded-[50px] text-[14px] font-semibold text-[#8059ca] mb-0"
      >
