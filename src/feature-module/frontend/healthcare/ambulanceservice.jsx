    ...
    return (
      <div className="!flex !justify-center !items-center !mt-8">
        <ul className="!flex !justify-center !items-center !gap-2 !p-0 !m-0 !list-none">
          <li>
            <button
              className="!w-9 !h-9 !flex !items-center !justify-center !rounded-xl !border !border-solid !border-gray-200 !bg-white !text-gray-600 hover:!bg-[#8059ca]/10 hover:!text-[#8059ca] disabled:!opacity-40 disabled:!cursor-not-allowed !transition-all !duration-300"
                ...
                <li key={page}>
                  <button
                    className={`!w-9 !h-9 !flex !items-center !justify-center !rounded-xl !border !border-solid !text-[13px] !font-medium !transition-all !duration-300 ${currentPage === page
                      ...
                      : "!bg-white !text-gray-700 !border-gray-200 hover:!bg-[#8059ca]/10 hover:!text-[#8059ca]"
                      }`}
  ...
  return (
    <>
            ...
            <div className="!mx-auto !max-w-[850px]">
              <form onSubmit={(e) => e.preventDefault()}>
                ...
                >
                  ...
                  {isLoading && (
                    <div
                      className="!w-4 !h-4 !border-2 !border-solid !border-[#8059ca] !border-t-transparent !rounded-full !animate-spin"
                      role="status"
                    >
      ...
      <div className="!flex !justify-center !gap-3 md:!gap-4 !my-6 !flex-wrap !px-3">
        ...
        <button
          className="!flex !items-center !gap-2 !py-2.5 !px-5 !text-[13px] md:!text-[14px] !font-medium !rounded-[8px] !bg-[#8059ca] !text-white hover:!bg-[#6d48b8] hover:!-translate-y-[1px] !shadow-[0_4px_12px_rgba(128,89,202,0.18)] hover:!shadow-[0_6px_16px_rgba(128,89,202,0.25)] !transition-all !duration-300 !border-none !cursor-pointer"
          data-tooltip-id="global-tooltip"
        ...
        (categories && categories.length > 0 && !searchQuery)) && (
          <section className="!mx-2 !pt-4 !pb-6 !bg-[#f8f4ff] !rounded-2xl">
            <div className="container-fluid !px-4 md:!px-6 !mx-auto">
              <h2 className="!text-[24px] md:!text-[28px] !font-semibold !mb-6 !text-center !bg-gradient-to-br !from-[#8059ca] !to-[#6d48b8] !bg-clip-text !text-transparent">
                Patient Transport Services
                {filteredEmergencyVehicles.length > 0 &&
                ...
                {emergencyCurrentItems.map((vehicle, index) => (
                  <div key={emergencyStartIndex + index} className="!w-full">
                    <div className="!bg-white !rounded-md !p-4 !shadow-[0_4px_16px_rgba(0,0,0,0.04)] !border !border-solid !border-gray-100 hover:!shadow-lg hover:!-translate-y-1 !transition-all !duration-300 !flex !flex-col !justify-between !h-full">
                      ...
                      <button
                        className="!w-full !mt-4 !py-2 !rounded-lg !bg-[#8059ca] hover:!bg-[#6d48b8] !text-white !font-semibold !text-[13px] !transition-all !duration-300 !border-none !cursor-pointer"
              ...
              {topBookedCurrentItems.map((vehicle, index) => (
                <div key={topBookedStartIndex + index} className="!w-full">
                  <div className="!bg-white !rounded-2xl !p-4 !shadow-[0_4px_16px_rgba(0,0,0,0.04)] !border !border-solid !border-gray-100 hover:!shadow-lg hover:!-translate-y-1 !transition-all !duration-300 !flex !flex-col !justify-between !h-full">
                    ...
                    <button
                      className="!w-full !mt-4 !py-1 !rounded-sm !bg-[#8059ca] hover:!bg-[#6d48b8] !text-white !font-semibold !text-[13px] !transition-all !duration-300 !border-none !cursor-pointer"
                      onClick={(e) => handleBookNow(e, vehicle)}
                    >
                      Book Now
                    </button>
        ...
        <section className="!py-8 !px-3 !bg-[#f8f4ff] !rounded-2xl !mt-6">
          <div className="container-fluid !px-4 md:!px-6 !mx-auto">
            <div className="!text-center !mb-6">
              <h2 className="!text-[24px] md:!text-[28px] !font-semibold !bg-gradient-to-br !from-[#8059ca] !to-[#6d48b8] !bg-clip-text !text-transparent">
                <i className="fas fa-bolt !mr-2 !text-[#8059ca]" />
                Offers & Promotions
              </h2>
            </div>
      ...
      <section className="!py-16 !bg-[#E8E4F5] bg-[url('/assets/Medicompares%20Background.png')] !bg-cover !bg-center !bg-no-repeat !rounded-2xl !mx-2 !mt-6">
        <div className="container-fluid !px-4 md:!px-6 !mx-auto !max-w-[1320px]">
          ...
          <div className="!text-center !mb-10">
            <div className="!inline-flex !items-center !gap-2 !bg-[#8059ca]/10 !border !border-solid !border-[#8059ca]/25 !rounded-full !py-1.5 !px-4 !text-[12px] !font-bold !tracking-wider !uppercase !text-[#8059ca] !mb-3">
              <i className="fas fa-bolt !text-yellow-500" /> Fast Emergency Dispatch
            </div>
            <h2 className="!text-[28px] md:!text-[32px] !font-semibold !bg-gradient-to-br !from-[#8059ca] !to-[#6d48b8] !bg-clip-text !text-transparent !mb-2">
              Booking Process
            </h2>
          ...
          <div className="!bg-white !rounded-3xl !border !border-solid !border-gray-200 !shadow-[0_12px_35px_rgba(128,89,202,0.05)] !p-6 md:!p-10">
            <div className="!flex !flex-col lg:!flex-row !items-stretch !gap-8">
              ...
              <div className="!w-full lg:!w-5/12 !flex !flex-col !justify-center">
                <div className="!bg-white !rounded-2xl !p-3 !shadow-[0_10px_30px_rgba(128,89,202,0.06)] !border !border-solid !border-[#8059ca]/15 !overflow-hidden">
                  <img
                  ...
                  <div className="!flex !items-center !justify-between !gap-2 !mt-3">
                    <span className="!flex-1 !flex !items-center !justify-center !gap-1.5 !text-[11.5px] !font-medium !py-2 !px-2 !rounded-lg !border !border-solid !border-[#8059ca]/15 !bg-[#f8f4ff] !text-[#8059ca]">
                      <i className="fas fa-bolt !text-yellow-500 !text-[12px]" /> Fast Dispatch
                    </span>
                    <span className="!flex-1 !flex !items-center !justify-center !gap-1.5 !text-[11.5px] !font-medium !py-2 !px-2 !rounded-lg !border !border-solid !border-[#8059ca]/15 !bg-[#f8f4ff] !text-[#8059ca]">
                      <i className="fas fa-map-marker-alt !text-[#8059ca] !text-[12px]" /> Live GPS
                    </span>
                    <span className="!flex-1 !flex !items-center !justify-center !gap-1.5 !text-[11.5px] !font-medium !py-2 !px-2 !rounded-lg !border !border-solid !border-[#8059ca]/15 !bg-[#f8f4ff] !text-[#8059ca]">
              ...
              <div className="!w-full lg:!w-7/12">
                <div className="!flex !flex-col !gap-5 !h-full !justify-between">
                  {[
                    ...
                    <div
                      key={step.num}
                      className="!bg-white !rounded-sm !shadow-[0_8px_24px_rgba(128,89,202,0.04)] !border !border-solid !border-gray-100 !flex !items-start !transition-all !duration-300 !relative !overflow-hidden hover:!-translate-y-1 hover:!border-[#8059ca] hover:!shadow-[0_12px_30px_rgba(128,89,202,0.1)] !p-5 md:!p-6 !gap-4 md:!gap-5"
                    >
                      <span className="!absolute !top-4 !right-5 !text-[24px] !font-mono !font-bold !text-[#8059ca]/10">
                        {step.num}
                      </span>

                      <div className="!w-14 !h-14 !rounded-xl !bg-[#f8f4ff] !flex !items-center !justify-center !shrink-0 !border !border-solid !border-[#8059ca]/20 !shadow-sm !self-center">
                        <i className={`${step.icon} !text-[22px] !text-[#8059ca]`} />
                      </div>
                      ...
                      <div className="!flex-1 !min-w-0 !pr-6">
                        ...
                        <div className="!flex !flex-wrap !gap-2">
                          {step.tags.map((tag, i) => (
                            <span key={i} className="!text-[11px] !font-medium !py-0.5 !px-2.5 !rounded-full !text-[#8059ca] !bg-[#f8f4ff]">
                              {tag}
                            </span>
                          ))}
                        </div>
          ...
          <div className="!grid !grid-cols-1 sm:!grid-cols-2 lg:!grid-cols-4 !gap-6">
            {[
              ...
              <div key={index} className="!w-full">
                <div className="!bg-white !rounded-sm !p-6 !text-center !border !border-solid !border-gray-100 !h-full !transition-all !duration-300 hover:!-translate-y-1 hover:!shadow-[0_8px_20px_rgba(128,89,202,0.1)] hover:!border-[#8059ca]">
                  <div className="!w-12 !h-12 !rounded-xl !flex !items-center !justify-center !mx-auto !mb-4 !shadow-sm !bg-gradient-to-br !from-[#8059ca] !to-[#6d48b8]">
                    <i className={`${item.icon} !text-[20px] !text-white`} />
                  </div>

                  <h5 className="!text-[16px] !font-medium !mb-2 !leading-snug !text-[#8059ca]">
                    {item.title}
                  </h5>
              ...
              {faqs.map((faq) => (
                ...
                >
                  ...
                  >
                    ...
                    <span className="!text-[16px] !font-bold !transition-all !duration-300 !flex !items-center !justify-center !w-6 !h-6 !text-[#8059ca]">
                      {expandedFaq === faq.id ? (
