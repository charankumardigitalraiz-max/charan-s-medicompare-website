                    ...
                    return (
                      ...
                      >
                        <div
                          ...
                          className={`service-partner-card${isMobile ? " service-partner-card--mobile" : ""} flex flex-col justify-start items-center overflow-hidden ${isMobile ? "h-[80px] w-[80px]" : "h-[165px] w-full"}`}
                        >
                          {!isMobile ? (
                            <>
                              <div
                                className="w-full h-[100px] rounded-[8px] bg-[#faf9fe] overflow-hidden flex items-center justify-center p-[6px] mb-[10px]"
                              >
                                <img
                                  src={
                                    businessImage
                              ...
                              <h6
                                className="mb-0 !text-[13px] !font-semibold text-[#222] text-center leading-[1.4] [display:-webkit-box] [-webkit-line-clamp:2] [-webkit-box-orient:vertical] overflow-hidden"
                              >
                                {businessName || "N/A"}
                              </h6>
                            </>
