                                ...
                                return (
                                  <>
                                    <img
                                      ...
                                      className="max-w-full h-[230px] w-full object-contain bg-white p-[10px] rounded-[6px] border block transition-transform duration-300 will-change-transform"
                                      style={{
                                ...
                                <div className="flex flex-col items-center">
                                  {maxThumbnails > 1 && (
                                    <div className="flex items-center gap-1">
                                      ...
                                      <div
                                        className="flex gap-2 justify-center mt-3 overflow-hidden"
                                      >
                                        {allImages
                                          .slice(
                                            thumbnailStartIndex,
                                          ...
                                          .map((img, idx) => {
                                            ...
                                            return (
                                              <img
                                                ...
                                                className={`w-[55px] h-[55px] object-contain border rounded-[6px] p-[5px] bg-white cursor-pointer transition-all duration-200 ${selectedImageIndex === actualIndex ? "border-[#8059ca] shadow-[0_0_0_2px_rgba(128,89,202,0.3)]" : "border-[#ddd]"}`}
                                                onClick={() =>
